...
public class UserServiceTest {
    ...
    public void testDatainitialization() {
        ...
        for (User user : userService.getAllUsers()) {
            if ("admin".equals(user.getUsername())) {
                ...
                Assertions.assertTrue(user.getRoles().contains(UserRole.LOCATION_MANAGER), "User \"" + user + "\" does not have role LOCATION_MANAGER");
                Assertions.assertNotNull(user.getCreateUser(), "User \"" + user + "\" does not have a createUser defined");
                Assertions.assertNotNull(user.getCreateDate(), "User \"" + user + "\" does not have a createDate defined");
                Assertions.assertNull(user.getUpdateUser(), "User \"" + user + "\" has a updateUser defined");
                Assertions.assertNull(user.getUpdateDate(), "User \"" + user +"\" has a updateDate defined");
            } else if ("user2".equals(user.getUsername())) {
                Assertions.assertTrue(user.getRoles().contains(UserRole.USER), "User \"" + user + "\" does not have role USER");
                Assertions.assertNotNull(user.getCreateUser(), "User \"" + user + "\" does not have a createUser defined");
                Assertions.assertNotNull(user.getCreateDate(), "User \"" + user + "\" does not have a createDate defined");
                Assertions.assertNull(user.getUpdateUser(), "User \"" + user + "\" has a updateUser defined");
                Assertions.assertNull(user.getUpdateDate(), "User \"" + user + "\" has a updateDate defined");
    ...
    public void testCreateUser() {
        ...
        toBeCreatedUser.setRoles(Sets.newSet(UserRole.USER, UserRole.LOCATION_MANAGER));
        ...
        Assertions.assertTrue(freshlyCreatedUser.getRoles().contains(UserRole.LOCATION_MANAGER), "User \"" + username + "\" does not have role LOCATION_MANAGER");
